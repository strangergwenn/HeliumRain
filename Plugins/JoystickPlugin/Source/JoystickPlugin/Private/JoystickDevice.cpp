...
void FJoystickDevice::InitInputDevice(const FDeviceInfoSDL &Device)
{
	...
	{
		FString strName = FString::Printf(TEXT("Joystick_%s_Axis%d"), *DeviceInfo.DeviceName.Left(15), iAxis);
	...
	{
		FString strName = FString::Printf(TEXT("Joystick_%s_Button%d"), *DeviceInfo.DeviceName.Left(15), iButton);
		UE_LOG(JoystickPluginLog, Log, TEXT("add %s %i"), *strName, DeviceId.value);
	...
	for (int iAxis = 0; iAxis < 2; iAxis++)
	{
		...
		{
			FString strName = FString::Printf(TEXT("Joystick_%s_Hat%d_%s"), *DeviceInfo.DeviceName.Left(15), iHat, *_2DaxisNames[iAxis]);
			UE_LOG(JoystickPluginLog, Log, TEXT("add %s %i"), *strName, DeviceId.value);
			FKey key{ *strName };
	...
	for (int iAxis = 0; iAxis < 2; iAxis++)
	{
		...
		{
			FString strName = FString::Printf(TEXT("Joystick_%s_Ball%d_%s"), *DeviceInfo.DeviceName.Left(15), iBall, *_2DaxisNames[iAxis]);
			UE_LOG(JoystickPluginLog, Log, TEXT("add %s %i"), *strName, DeviceId.value);
			FKey key{ *strName };
