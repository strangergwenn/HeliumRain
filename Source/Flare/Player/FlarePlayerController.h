...
public:
	...
	void Notify(FText Text, FText Info, EFlareNotification::Type Type = EFlareNotification::NT_General, float Timeout = 10.0f, EFlareMenu::Type TargetMenu = EFlareMenu::MENU_None, void* TargetInfo = NULL);
