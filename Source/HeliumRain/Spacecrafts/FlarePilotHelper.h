...
struct PilotHelper
{
	...
	static FVector AnticollisionCorrection(AFlareSpacecraft* Ship, FVector InitialVelocity, float PreventionDuration, AFlareSpacecraft* SpacecraftToIgnore = NULL, float SpeedLimit);
