		...
		[
			...
			[
				...
				[
					...
					// TODO GWENN : replace [Licensor] by company name
					+ SScrollBox::Slot()
					[
						SNew(STextBlock)
						.Text(LOCTEXT("DONT-TRANSLATE-EULA-Text", "Helium Rain includes the Unreal® Engine code and other code, materials, and information " \
							...
							"Without limiting the generality of the foregoing, [Licensor], Epic, and Epic's affiliates make no warranty that \n" \
							...
							"Epic Materials. \n\n" \
							"This paragraph will apply to the maximum extent permitted by applicable law. To the maximum extent permitted by applicable law, neither[Licensor], " \
							"Epic, Epic's licensors, nor its or their affiliates, nor any of[Licensor]'s or Epic's service providers, shall be liable in any way for loss or damage of any kind " \
							...
							"work stoppage, computer failure, or malfunction, or any and all other commercial damages or losses. In no event will [Licensor], Epic, Epic's licensors, " \
							"nor its or their affiliates, nor any of[Licensor]'s or Epic's service providers be liable for any loss of profits or any indirect, incidental, consequential, " \
							...
							"to use or lack of functionality of the Epic Materials, even in the event of[Licensor]'s, Epic's, or Epic's affiliates' fault, tort(including negligence), " \
							"strict liability, indemnity, product liability, breach of contract, breach of warranty, or otherwise and even if[Licensor], Epic or Epic's affiliates " \
							...
							"in such states or jurisdictions, the liability of[Licensor], Epic, Epic's licensors, its and their affiliates, and any of[Licensor]'s or Epic's service " \
